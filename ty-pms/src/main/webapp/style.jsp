...
<link href="tools/zTree_v3-master/css/zTreeStyle/zTreeStyle.css" rel="stylesheet" type="text/css">
-->

<!-- jquery.fancybox -->
<link href="style/common/jquery.fancybox-1.3.4.css" rel="stylesheet" type="text/css" media="screen"></link>


<!-- 自定义main.jsp -->
<link href="style/common/main.css" rel="stylesheet" type="text/css" />

<!-- 自定义 all jsp -->
<link href="style/common/commonAll.css" rel="stylesheet" type="text/css" />
...
<!-- zTree 
<script type="text/javascript" src="tools/zTree_v3-master/js/jquery.ztree.all.js"></script>
-->
<script type="text/javascript" src="scripts/zTree/jquery.ztree.core-3.2.js"></script>
<script type="text/javascript" src="scripts/zTree/jquery.ztree.excheck-3.2.js"></script>
<script type="text/javascript" src="scripts/zTree/jquery.ztree.exedit-3.2.js"></script>
<script type="text/javascript" src="tools/zTree_v3-master/js/jquery.ztree.exhide.js"></script>
 
<!-- 自定义 main.jsp -->
<script type="text/javascript" src="scripts/common/main.js"></script> 
